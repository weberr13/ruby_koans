...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # startig at the given agument collect a function with arguments
    # where the first argument is continuously passed to each collection call
    # e.g. this is a fold operation from FP
  end
  ...
  #
  # by acting on the open IO object we avoid closing/etc.  This is a more FP way
  # to do things.   YUP, I was correct.
